...
static_inline int
rx_IsLoopbackAddr(struct sockaddr *saddr)
{
    return ((((struct sockaddr_in *)saddr)->sin_addr.s_addr & 0xffff0000) == 0x7f000000);
}
...
struct rx_service {
    ...
    struct sockaddr_storage saddr; /* IP address and UDP port for this service */
