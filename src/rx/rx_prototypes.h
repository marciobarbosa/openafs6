...
extern struct rx_connection *rx_NewConnectionSA(struct sockaddr *saddr, u_short sservice,
...
extern afs_int32 rx_GetServerPeers(osi_socket socket, struct sockaddr *saddr,
				   ...
				   afs_uint32 * supportedValues);
extern afs_int32 rx_GetLocalPeers(struct sockaddr *saddr,
...
extern osi_socket rxi_GetHostUDPSocket(struct sockaddr *saddr);
